package cn.uenit.quizz.base.repository.impl;


import cn.uenit.quizz.base.entity.BaseEntity;
import cn.uenit.quizz.base.repository.IBaseRepository;
import cn.uenit.quizz.base.specification.SpecificationUtils;
import cn.uenit.quizz.base.utils.ReflectionUtil;
...
public class BaseRepositoryImpl<T extends BaseEntity<I>, I extends Serializable> extends SimpleJpaRepository<T, I> implements IBaseRepository<T, I> {
    ...
    @Override
    public List<T> findAllEntities(Specification<T> specification) {
        return findAll(specification);
    }
}
